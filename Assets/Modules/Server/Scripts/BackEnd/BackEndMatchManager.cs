...
{
    [Header("Setting")]
    public int matchIdleTime;

    [Header("Key")]
    [SerializeField]
    private string KEY_DISCONNECTED_FROM_SERVER;
    [SerializeField]
    private string KEY_CONNECTING_TO_MATCH_SERVER;
    [SerializeField]
    ...
    private void MatchMakingHandler()
    {
        ...
        Backend.Match.OnLeaveMatchMakingServer += (args) =>
        {
                ...
                || args.ErrInfo.Category.Equals(ErrorCode.NetworkTimeout))
            {
                ...
                AlertMessage.Instance.SetMessage(Lingua.Lingua.GetString(KEY_DISCONNECTED_FROM_SERVER));
                /*
